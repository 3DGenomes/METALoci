...
def get_kk_plot(mlobject: mlo.MetalociObject, restraints: bool = True):
    ...
    sns.scatterplot(
        x=[xs[mlobject.poi - 1]], y=[ys[mlobject.poi]], s=POINTSIZE * 1.5, ec="lime", fc="none", zorder=3 # marcius DO NOT SUBSTRACT 1
    )
...
def get_gaudi_signal_plot(mlobject: mlo.MetalociObject, lmi_geometry: pd.DataFrame):
    ...
    poi = lmi_geometry.loc[lmi_geometry["moran_index"] == mlobject.poi, "bin_index"].iloc[0] # marcius DO NOT SUBSTRACT 1
...
def get_gaudi_type_plot(
    ...
    """
    poi = lmi_geometry.loc[lmi_geometry["moran_index"] == mlobject.poi, "bin_index"].iloc[0] # marcius DO NOT SUBSTRACT 1 from POI!
...
def get_lmi_scatterplot(
    ...
    sns.scatterplot(
        x=[x[mlobject.poi]], y=[y[mlobject.poi]], s=150, ec="lime", fc="none", zorder=len(lmi_geometry) # marcius DO NOT SUBSTRACT 1
    )
